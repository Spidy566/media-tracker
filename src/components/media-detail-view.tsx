...
export function MediaDetailView({
  title, imageUrl, subtitle, description, tags,
  status, rating, notes, statuses, backHref,
  onStatusChange, onRatingChange, onNotesBlur, onDelete, isDeleting,
  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      ...
      <div className="flex gap-6">
        {imageUrl && <img src={imageUrl} alt={title} className="rounded-md w-40" />}
        <div>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <Select value={rating?.toString() ?? ""} onValueChange={(v) => onRatingChange(Number(v))}>
